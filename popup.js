...
function getContentFirst5letters()
{
...
function getDataTest2(searchTerm, callback, errorCallback) {

  // Google image search - 100 searches per day.
  // https://developers.google.com/image-search/
  var searchUrl =   "https://nnn15.pythonanywhere.com/analyzeText?urlToAnalyze=ggg";
...
document.addEventListener('DOMContentLoaded', function() {
  getCurrentTabUrl(function(url) {
    ...
    getDataTest2(url, function(text) {
